...
AI 能做的事越来越多，人自己动手学习的动力却越来越少。小助不想再做一件"替你干活"的工具——**这类工具已经够多了**（Codex、Claude Code、OpenCode、Workbuddy……它们都能写代码、改文档、跑任务）。小助做的事恰恰相反：

> **它不帮你做事，只记下你该做什么，然后督促你去做。**

- **记下你该做什么**：你随口说的目标，它拆解成阶段和逐日计划，每天提醒你该推进哪一步；
- **催你去做**：它不会替你写代码、编辑文档、完成工作——那些是你的功课。它只在旁边看着进度、到点提醒、逾期追问；
- **陪你**：对话沉淀进**记忆树**（长期、近似无限的记忆），几周前你随口说的决定它还记得。它了解你的学习节奏、偏好和性格，像一位真正认识你的伙伴，而不是"用过即忘"的对话框。

**为什么记忆这么重要**——长期记忆既是人设一致性的基础，也是陪伴的前提。随随便便就把你忘了，那也不叫陪伴。这也是它的人设来源：它的提示词**非常简短**，因为上下文是无限的；在日复一日的对话里，它会不断总结与你的互动，**一步一步完善自己的人设**——而不是一开始就写死一段固定的角色卡。

技术形态：Python + LangChain 的桌面悬浮球 Agent（Electron 前端），全本地语音能力（合成/识别/OCR）离线可用。它可以接收你拖进来的文档、查看你的屏幕和桌面上的文字，但这都是为了**理解你的处境**，好把该做的事讲清楚——动手的永远是你。
